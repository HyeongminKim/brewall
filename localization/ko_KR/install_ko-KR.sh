##### Environment Check #####
### OS Check
export ERR_OS="\e[31m$(uname -s) 는 아직 지원하지 않습니다. \e[m"
export ERR_CHK_DPY="\e[31m의존성 패키지를 검증할 수 없기 때문에 종료되었습니다.\e[m"

### Development Tools Check
export INFO_XCS="\e[33mxcode-select 설치를 끝낸 후 다시 실행하여 주세요. \e[m"

### Version Check
export APY_RST="\e[33m변경 사항을 적용하기 위해 다시 실행하여 주세요. \e[m"
...
##### Directory Create #####
export CONF_DIR_MKDIR="brewall 설정 폴더를 생성하였습니다. 설정 폴더는 \e[0;1m$HOME/Library/Application\ Support/com.greengecko.brewall\e[m에 위치할 것입니다. "
export LOG_DIR_MKDIR_FRONT="brewall 로그 폴더를 생성하였습니다. 모든 로그 파일들은\e[0;1m"
export LOG_DIR_MKDIR_BACK="\e[m에 위치할 것입니다. "
...
### Instruction
export SYS_STATUS_TITLE="\e[0;1m현재 시스템 사양\e[m"
...
export HOME_REQ_TITLE="\e[0;1mHomebrew macOS 요구사항\e[m"
...
export HOME_INSTALL_TITLE="\n\e[0;1mHomebrew 설치 방법\e[m"
export HOME_INSTALL_INFO_1="\e[0;1mhttps://brew.sh/index_ko\e[m 이 사이트에 들어가서 Homebrew를 수동으로 설치하거나"
...
export TIGER_REQ_TITLE="\e[0;1mTigerbrew macOS 요구사항\e[m"
export TIGER_REQ_CPU="Power PC"
export TIGER_REQ_OS="Tiger or Leopard 권장\n"

### TigerBrew Install Guide
export TIGER_INSTALL_TITLE="\n\e[0;1mTigerbrew 설치 방법\e[m"
export TIGER_INSTALL_INFO_1="\e[0;1mhttps://github.com/mistydemeo/tigerbrew\e[m 이 사이트에 들어가서 Tigerbrew를 수동으로 설치하거나"
